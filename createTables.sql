...
CREATE TABLE PARTICIPANTS(
    ...
    CONSTRAINT CHECK_CONFIRMATION (CONFIRMATION IN ('ATTENDING', 'UNSURE', 'DECLINES', 'NOT_REPLIED')),
...
CREATE TABLE ALBUMS(
    ...
    CONSTRAINT CHECK_VISIBILITY (ALBUM_VISIBILITY IN ('EVERYONE', 'FRIENDS', 'FRIENDS_OF_FRIENDS', 'MYSELF')),
...
CREATE TABLE PHOTOS(
    ...
    FOREIGN_KEY (ALBUM_ID) REFERENCES ALBUMS
);
...
CREATE TRIGGER order_friends pairs
