...
CREATE TABLE FRIENDS(
    ...
    CONSTRAINT friends_self CHECK (USER1_ID <> USER2_ID)
);
...
CREATE TABLE CITIES(
    ...
    CONSTRAINT UNIQUE_COMBOS UNIQUE (CITY_NAME, STATE_NAME, COUNTRY_NAME),
    PRIMARY KEY (CITY_ID)
);
...
ALTER TABLE ALBUMS ADD CONSTRAINT cover_id FOREIGN KEY (COVER_PHOTO_ID) REFERENCES PHOTOS(PHOTO_ID)
INITIALLY DEFERRED DEFERRABLE;
ALTER TABLE ALBUMS ADD CONSTRAINT album_id FOREIGN KEY (ALBUM_OWNER_ID) REFERENCES USERS(USER_ID)
INITIALLY DEFERRED DEFERRABLE;
ALTER TABLE ALBUMS ADD CONSTRAINT photo_id FOREIGN KEY (ALBUM_ID) REFERENCES ALBUMS(ALBUM_ID)
INITIALLY DEFERRED DEFERRABLE;
